...
// function definition; prints elements under the main diagonal
void printlowd(int arr[][30], int n)
{
    int i = 0, j = 0;
    ...
    while (i < n)
    {
        ...
        while (j < n)
        {
            // j should be < n for the element arr[i][j] to be under the main diagonal
            if (j < i)
            {
                printf("%d ", arr[i][j]);
            }
